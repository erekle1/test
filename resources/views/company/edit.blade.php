        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('update_company',
                        ['company'=>$company->slug])
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email"
                                           ...
                                           value="{{ $company->email }}" autocomplete="email">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="url" type="url" value="{{ $company->website }}"
...
@enderror" name="website">
                            ...
                            <div class="form-group row">
                                <label for="file" class="col-md-4 col-form-label text-md-right">Logo</label>

                                <div class="col-md-6">
                                    <input id="file" type="file" class="form-control-file" name="logo">
                                </div>
                            </div>
